...
def clean_ncm(ncm: str) -> str:
    ...
    """
    # ⚡ Bolt Optimization: generator comprehension is faster than re.sub for strict ASCII digit filtering
...
def split_ncm_query(query: str) -> List[str]:
    ...
    """
    # ⚡ Bolt Optimization: chained replace and split is significantly faster than re.split
