...
def clean_ncm(ncm: str) -> str:
    ...
    """
    # ⚡ Bolt: Using generator comprehension with explicit charset is faster than re.sub and safer than str.isdigit()
...
def split_ncm_query(query: str) -> List[str]:
    ...
    """
    # ⚡ Bolt: Using chained string replacements and split is ~8x faster than re.split
