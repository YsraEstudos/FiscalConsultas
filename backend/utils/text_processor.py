...
class PortugueseStemmer:
    ...
    def _cached_stem(word: str) -> str:
        """
        Performance optimization: LRU cache for stemming.
        Implemented as a staticmethod to avoid including `self` in the cache key,
        preventing cache misses across multiple processor instances and reducing
        redundant word processing for full-text search.
        """
        word = word.lower()
