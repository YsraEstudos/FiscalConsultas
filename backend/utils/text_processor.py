...
class PortugueseStemmer:
    ...
    def stem(word: str) -> str:
        # ⚡ Optimization: bounded lru_cache applied to staticmethod avoids caching `self`
        # and reuses cached stems across different documents and queries, dramatically
        # improving full-text search performance since the stemmer processes the same words repeatedly.
        word = word.lower()
