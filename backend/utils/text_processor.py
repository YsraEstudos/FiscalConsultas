...
class PortugueseStemmer:
    ...
    # ⚡ Bolt Optimization:
    # Use a bounded LRU cache on a static method to memoize stemming results globally.
    # Because PortugueseStemmer is instantiated multiple times (e.g., in NeshTextProcessor),
    # an instance-level cache would include `self` in the key, causing cache misses and
    # memory leaks. A static method cache prevents this and shares cached words across queries.
    @staticmethod
