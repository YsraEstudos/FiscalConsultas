...
class PortugueseStemmer:
    ...
    def stem(word: str) -> str:
        """
        ⚡ Bolt: Cached text stemmer.
        Memoizing the stemming operation improves text processing performance
        for repeated words across documents and FTS queries. Bounded lru_cache
        on staticmethod avoids caching `self` across instances.
        """
        word = word.lower()
