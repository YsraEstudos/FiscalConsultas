...
class PortugueseStemmer:
    ...
    def _cached_stem(word: str) -> str:
        # Optimization: use lru_cache on a staticmethod to cache words
        # across multiple documents/queries without caching 'self',
        # which avoids memory leaks and increases cache hits.
        word = word.lower()
